...
$data	=	array();
$data	=	$db->get_class_id($invoice_id);
...
if(isset($_POST['submit']))
	{
	   ...
	   $e1_start_time		=$_POST['start_time'];
		...
		if($db->edit_class($e1_class_id,$e1_start_time,
            $e1_end_time,$e1_date,$e1_room_id,$e1_teacher_id,$e1_remark,$invoice_id
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Class Routine</h1>
                ...
                <div class="form-outline mb-4">
                                  ...
                                  <select name="class_id" id="s2" class="form-control" value="<?php echo $class_id; ?>">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="time" name="end_time" class="form-control" title="Error Message" value="<?php echo $end_time; ?>" pattern="[1-9]{1}[0-9]{9}"  required/>
                  ...
                  <div class="row mb-4">
                    <div class="col">
                      <div class="form-outline">
                        <input type="date" name="date" class="form-control" value="<?php echo $date_s; ?>"  required/>
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <select name="room_id" id="s2" value="<?php echo $room_id; ?>" class="form-control">
                  ...
                  <div class="row mb-4">
                    <div class="col">
                      <div class="form-outline">
                          ...
                          <select name="teacher_id" id="s2" class="form-control" value="<?php echo $tecaher_id; ?>">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="text" name="remark" class="form-control" value="<?php echo $remark; ?>" title="Error Message"   />

...
if (isset($_POST['submit'])) {
    ...
    $e1_subject        = $_POST['subject_id'];
    $e1_class_id        = $_POST['class_id'];
    $e1_c_p_w        = $_POST['c_p_w'];
    $e1_timing       = $_POST['timing'];
    $e1_timing       = $_POST['timing'];
    ...
    $e1_subject_name =  $db->get_subject_name2($e1_subject);





    if ($db->add_subject($e1_timing, $e1_break,$e1_class_id, $e1_class_name, $e1_subject_name, $e1_c_p_w, $e1_subject)) {
                    ...
                    <form action="index.php" method="post" name="myForm" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="col">
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    <div class="form-outline">
                                        ...
                                        <select name="break" id="s26" class="form-control">
                                        ...
                                        <label class="form-label" for="username">Select Break</label>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="number" name="c_p_w" class="form-control" required />
                                        <label class="form-label" for="form6Example2">Class per week</label>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        ...
                                        <label class="form-label" for="form6Example2">Class Timing</label>
                                    </div>
                                </div>

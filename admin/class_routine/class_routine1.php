...
if(isset($_POST['submit']))
    ...
    header("Location: ../Previou_routine/List.php?class_id=$e1_class_id");
     exit();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Class Routine</h1>
                       
                    </div>


                <form action="class_routine1.php" method="post" name="myForm" 

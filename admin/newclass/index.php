...
if (isset($_POST['submit'])) {
    ...
    $e1_class_name        = $_POST['class_name'];
    $e1_no_of_p        = $_POST['no_of_p'];





    if ($db->add_class_new($e1_class_name, $e1_no_of_p)) {
                ...
                <div class="container-fluid">
                    ...
                    <form action="index.php" method="post" name="myForm" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                <div class="form-outline">
                                    <select class="form-control" name="no_of_p" required>
                                        <option disabled>Select Number</option>
                                        <option value="7">7</option>
                                        <option value="6">6</option>
                                        <option value="4">4</option>
                                    </select>
                                    <label class="form-label" for="form6Example2">No Of Period</label>
                                </div>
                            </div>
                        </div>

...
if (isset($_POST['submit'])) {
    ...
    $e1_class_id        = $_POST['teacher_id'];

    header("Location: ../teacher_routine/teacher_routines.php?teacher_id=$e1_class_id");
    exit();
} //end
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Teacher Routine</h1>
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <select name="teacher_id" id="s2" class="form-control">
                                    ...
                                    <?php
                                    $data    =    array();
                                    $data    =    $db->get_teacher_routine_new();
                                    ...
                                    ?>
                                            <option value=<?php echo $e2; ?>><?php echo $e3; ?></option>
                                ...
                                <label class="form-label" for="username">Select Teacher</label>

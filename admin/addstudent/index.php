				...
				enctype="multipart/form-data" autocomplete="off">
                 ...
                 <div class="col">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="tel" name="mobile" class="form-control" title="Error Message" pattern="[1-9]{1}[0-9]{9}"  required/>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="text" name="f_name" class="form-control" title="Error Message"   required/>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="date" name="admission" class="form-control" title="Error Message"   required/>

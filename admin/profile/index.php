                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <p>ADMIN</p>
                                                                  <a href="../profileedit/index.php?edit_id=<?php echo $email; ?>" 
                                                                  onclick="return confirm('Are you Sure to Edit This record?');">
													           	<i class="fas fa-edit" style="color:green;margin-left:20px;"></i></a>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Work Location</p>
                                                                        <h6 class="text-muted f-w-400"><?php echo $work; ?></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Account Create</p>
                                                                        <h6 class="text-muted f-w-400">

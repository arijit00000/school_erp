...
$data	=	array();
$data	=	$db->get_student_id($invoice_id);
...
if(isset($_POST['submit']))
	{
      ...
      $e1_name		=$_POST['name'];
	   $e1_l_name		=$_POST['l_name'];
		...
		if($db->edit_profile($e1_name,$e1_email,
				...
				enctype="multipart/form-data" autocomplete="off">
                 ...
                 <div class="col">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="tel" name="mobile" class="form-control" value="<?php echo $mobile; ?>" title="Error Message" pattern="[1-9]{1}[0-9]{9}"  required/>

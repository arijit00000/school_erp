            ...
            <div id="content">
				...
				enctype="multipart/form-data" autocomplete="off">
                 ...
                 <div class="col">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="text" name="l_name" class="form-control" title="Error Message"  required/>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="tel" name="mobile" class="form-control" title="Error Message" pattern="[1-9]{1}[0-9]{10}" maxlength="11" required/>
                  ...
                  <!-- <div class="row mb-4" style="display: none">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="text" name="f_name" class="form-control" value="" title="Error Message"   />
                  ...
                  <!-- <div class="row mb-4" style="display: none">
                    <div class="col">
                      <div class="form-outline">
                                  ...
                                  <select value="" name="class_id" id="s2" class="form-control">
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="date" name="admission" value="" class="form-control" title="Error Message"   />
                        <label class="form-label" for="form6Example2">Date of joining</label>
                      </div>
                    </div>
                  </div> -->
                  ...
                  <div class="row mb-4" style="display: none">
                    <!-- <div class="col">
                      <div class="form-outline">
                                  ...
                                  <select value="" name="subject_id" id="s3" class="form-control">
                    ...
                    <!-- <div class="col">
                      <div class="form-outline">
                        <input type="text" value="" name="experinece" class="form-control" title="Error Message"   />
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="password" name="password" onkeyup="checkPass(); return false;" id="pass1" class="form-control"  required/>
                    ...
                    <div class="col">
                      <div class="form-outline">
                        ...
                        <label class="form-label" value="" for="form6Example1">serial number(For Class Routine eg:-1,2)</label>
                      </div>
                    </div>
                    ...
                    <div class="col">
                      <div class="form-outline">
                        <input type="number" name="routine"  class="form-control"  />
                        <label class="form-label" value="" for="form6Example2">Count(For Class Routine eg:-1,2 & 99  After)</label>
                      </div>
                       <div id="error-nwl"></div>
                    </div>
                  </div>
